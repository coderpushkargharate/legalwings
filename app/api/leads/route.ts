  ...
  try {
    ...
    if (mobile) {
      addOrGroup(andConditions, [
        ...
        { 'agreement.pvMobile': { $regex: mobile, $options: 'i' } },
      ]);
    }
    ...
    if (searchText) {
      ...
      addOrGroup(andConditions, [
        ...
        { 'agreement.pvMobile': { $regex: st, $options: 'i' } },
        { 'agreement.pvName': { $regex: st, $options: 'i' } },
        ...
        { 'agreement.owner.aadharNumber': { $regex: st, $options: 'i' } },
        { 'agreement.owner.panNumber': { $regex: st, $options: 'i' } },
        ...
        { 'agreement.tenant.aadharNumber': { $regex: st, $options: 'i' } },
        { 'agreement.tenant.panNumber': { $regex: st, $options: 'i' } },
        // Payment
